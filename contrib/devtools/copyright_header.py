...
EXCLUDE = [
    # auto generated:
    'src/qt/unitedworldmoneystrings.cpp',
...
EXPECTED_HOLDER_NAMES = [
    ...
    "The UnitedWorldMoney developers\n",
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The UnitedWorldMoney developers'
...
Arguments:
    <base_directory> - The base directory of a unitedworldmoney source code repository.
"""
