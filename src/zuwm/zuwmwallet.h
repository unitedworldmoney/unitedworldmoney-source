...
#ifndef UnitedWorldMoney_ZUWMWALLET_H
#define UnitedWorldMoney_ZUWMWALLET_H
...
public:
    CzUWMWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZUWM(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZUWM(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //UnitedWorldMoney_ZUWMWALLET_H
