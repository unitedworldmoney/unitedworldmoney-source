...
/** Utility functions used by the UnitedWorldMoney Qt UI.
 */
namespace GUIUtil
{
...
// Render UnitedWorldMoney addresses in monospace font
...
// Parse "unitedworldmoney:" URI into recipient object, return true on successful parsing
