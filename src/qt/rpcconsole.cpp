                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzUWMPathCustom = GetArg("-zuwmbackuppath", "");
    ...
    if(!strzUWMPathCustom.empty()) {
        ui->wallet_customzuwmbackuppath->setText(QString::fromStdString(strzUWMPathCustom));
        ui->wallet_customzuwmbackuppath_label->setVisible(true);
        ui->wallet_customzuwmbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzUWMPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the UnitedWorldMoney RPC console.") + "<br>" +
