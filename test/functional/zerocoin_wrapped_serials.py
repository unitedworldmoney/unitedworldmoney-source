...
from fake_stake.base_test import UnitedWorldMoney_FakeStakeTest

class zUWMwrappedSerialsTest(UnitedWorldMoney_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zUWMs..." % DENOM_TO_USE)
