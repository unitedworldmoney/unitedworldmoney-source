...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop UnitedWorldMoney server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "UnitedWorldMoney server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* UnitedWorldMoney features */
        {"unitedworldmoney", "listmasternodes", &listmasternodes, true, true, false},
        {"unitedworldmoney", "getmasternodecount", &getmasternodecount, true, true, false},
        {"unitedworldmoney", "masternodeconnect", &masternodeconnect, true, true, false},
        {"unitedworldmoney", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"unitedworldmoney", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"unitedworldmoney", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"unitedworldmoney", "masternodecurrent", &masternodecurrent, true, true, false},
        {"unitedworldmoney", "masternodedebug", &masternodedebug, true, true, false},
        {"unitedworldmoney", "startmasternode", &startmasternode, true, true, false},
        {"unitedworldmoney", "createmasternodekey", &createmasternodekey, true, true, false},
        {"unitedworldmoney", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"unitedworldmoney", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"unitedworldmoney", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"unitedworldmoney", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"unitedworldmoney", "getmasternodescores", &getmasternodescores, true, true, false},
        {"unitedworldmoney", "preparebudget", &preparebudget, true, true, false},
        {"unitedworldmoney", "submitbudget", &submitbudget, true, true, false},
        {"unitedworldmoney", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"unitedworldmoney", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"unitedworldmoney", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"unitedworldmoney", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"unitedworldmoney", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"unitedworldmoney", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"unitedworldmoney", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"unitedworldmoney", "checkbudgets", &checkbudgets, true, true, false},
        {"unitedworldmoney", "mnsync", &mnsync, true, true, false},
        {"unitedworldmoney", "spork", &spork, true, true, false},
        {"unitedworldmoney", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzuwmseed", &getzuwmseed, false, false, true},
        {"zerocoin", "setzuwmseed", &setzuwmseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzuwm", &searchdzuwm, false, false, true},
        {"zerocoin", "dzuwmstate", &dzuwmstate, false, false, true},
...
{
    return "> unitedworldmoney-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:36673/\n";
}
