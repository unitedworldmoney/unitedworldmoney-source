...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("UnitedWorldMoney Core unitedworldmoney-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  unitedworldmoney-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded unitedworldmoney transaction") + "\n" +
                               "  unitedworldmoney-tx [options] -create [commands]   " + _("Create hex-encoded unitedworldmoney transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded unitedworldmoney transaction
