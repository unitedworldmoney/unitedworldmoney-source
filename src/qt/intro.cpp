...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("UnitedWorldMoney Core"),
     ...
     * override -datadir in the unitedworldmoney.conf file in the default data directory
     * (to be consistent with unitedworldmoneyd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
