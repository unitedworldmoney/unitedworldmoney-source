...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::UWM);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeUnitedWorldMoneyAmount"))
        SoftSetArg("-anonymizeunitedworldmoneyamount", settings.value("nAnonymizeUnitedWorldMoneyAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in unitedworldmoney.cpp during shotdown to also remove the window positions
