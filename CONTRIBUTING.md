Contributing to UnitedWorldMoney Core
============================

The UnitedWorldMoney Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/unitedworldmoney-project/unitedworldmoney/blob/master/doc/translation_process.md)
...
The following applies to code changes to the UnitedWorldMoney Core project, and is not to be
confused with overall UnitedWorldMoney Network Protocol consensus changes.

Whether a pull request is merged into UnitedWorldMoney Core rests with the project merge
...
Patches that change UnitedWorldMoney consensus rules are considerably more involved than
...
Where a patchset proposes to change the UnitedWorldMoney consensus, it must have been
...
The project leader is the release manager for each UnitedWorldMoney Core release.
