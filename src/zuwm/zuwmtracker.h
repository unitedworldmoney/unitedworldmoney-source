...
#ifndef UnitedWorldMoney_ZUWMTRACKER_H
#define UnitedWorldMoney_ZUWMTRACKER_H
...
public:
    CzUWMTracker(std::string strWalletFile);
    ~CzUWMTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzUWMWallet* zUWMWallet = NULL);
...
#endif //UnitedWorldMoney_ZUWMTRACKER_H
